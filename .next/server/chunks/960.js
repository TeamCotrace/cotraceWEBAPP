...
/* harmony export */   "RK": () => (/* binding */ addhotcars),
/* harmony export */   "jb": () => (/* binding */ list_hotcars)
/* harmony export */ });
/* unused harmony export get_hotcars */
...
const get_hotcars = async (pnumber)=>{
    try {
        const res = await axios.post("https://cotraceweb.vercel.app" + "/api/Hot_cars/gethotcars", pnumber);
        return res.data;
    } catch (error) {
...
const Addhotcars = ()=>{
    ...
    const signUpHandler = async (e)=>{
        ...
        const result = await (0,_axios_hotcars__WEBPACK_IMPORTED_MODULE_5__/* .addhotcars */ .RK)(payload);
