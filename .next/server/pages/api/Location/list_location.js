...
async function handler(req, res) {
    if (req.method !== "POST") {
        ...
        try {
            ...
            console.log(userId);
            const getdata = await _models_Location__WEBPACK_IMPORTED_MODULE_1__/* ["default"].aggregate */ .Z.aggregate([
                {
                    $match: {
...
var __webpack_exports__ = __webpack_require__.X(0, [287], () => (__webpack_exec__(2904)));
